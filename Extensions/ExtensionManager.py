...
import inspect
from CommandManager.CommandManager import COMMAND_TYPE_ATTR
...
class ExtensionManager:
    ...
    def add_commands(self, module: ModuleType) -> Tuple[int, List[Callable]]:
        ...
        commands = list(filter(lambda function: COMMAND_TYPE_ATTR in dir(function), functions))
...
if __name__ == "__main__":
    ...
    cmd_test = cmds[-1]
    print(dir(cmd_test))
    print(getattr(cmd_test, COMMAND_TYPE_ATTR))
